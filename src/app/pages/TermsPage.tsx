...
export default function TermsPage({ darkMode }: { darkMode: boolean }) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Glass className="p-8">
          <div className="space-y-4 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            <p>
              This is a placeholder terms page. Replace this text with your official Terms of Service.
            </p>
            <p>
              Use of the service is subject to your compliance with applicable laws and policies.
            </p>
          </div>
        </Glass>
      </div>
